import BannerQuemSomos from '../../assets/backgroundQuemSomos.png'
    ...
    return(
        <section className={styles.quemSomos}>
            <div className={styles.boxBanner}>
                 <img src={BannerQuemSomos} className={styles.banner} alt="banner" />
            </div>
            ...
            <article className={styles.artigo}>
                ...
                <p>á anos, trabalhamos aproximando quem quer ajudar de quem precisa, promovendo ações sociais estruturadas, transparentes e alinhadas às necessidades das comunidades. Acreditamos que a transformação acontece quando propósito, colaboração e responsabilidade caminham juntos.</p>
